...
export class CategoriesService {
  ...
  async create(createCategoryDto: CreateCategoryDto) {
    ...
    const category = await this.prisma.category.create({
      data: {
        ...
        sortOrder: categoryData.order ?? 0,
  ...
  async update(id: string, updateCategoryDto: UpdateCategoryDto) {
    ...
    if (categoryData.imageUrl !== undefined) updateData.image = categoryData.imageUrl;
    if (categoryData.order !== undefined) updateData.sortOrder = categoryData.order;
    if (categoryData.isActive !== undefined) updateData.isActive = categoryData.isActive;
    if ((categoryData as { metaTitle?: string }).metaTitle !== undefined) updateData.metaTitle = (categoryData as { metaTitle?: string }).metaTitle;
    if ((categoryData as { metaDescription?: string }).metaDescription !== undefined) updateData.metaDescription = (categoryData as { metaDescription?: string }).metaDescription;
