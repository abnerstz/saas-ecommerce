 ...
 */
function getProductConfig(niche) {
    return exports.PRODUCT_CONFIGS[niche] || exports.PRODUCT_CONFIGS.other;
}
/**
 * Obter configuração de tema por nicho
 */
function getThemeConfig(niche) {
    return exports.THEME_CONFIGS[niche] || exports.THEME_CONFIGS.other;
}
/**
 * Obter campos específicos por nicho
 */
function getNicheFields(niche) {
    return getProductConfig(niche).fields;
}
/**
 * Obter seções customizadas por nicho
 */
function getNicheSections(niche) {
    return getProductConfig(niche).customSections;
}
//# sourceMappingURL=niche-configs.js.map